                ...
                <div class="col-12">
                    ...
                    <div class="row padding">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <p>
                            <!--Avatar Image-->
                            <img src="img/timematter-image.png" class="img-fluid mx-auto d-block" role="img">
                            </p>    
                        </div>
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <p>
                                A source of power that Guardian Kazran wields that controls time. It can bring forth a time in the past that no one can remember.
                            </p>
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactGrade, ArtifactClass, ArtifactHealth, ArtifactAttack FROM tblartifacts WHERE ArtifactID = 5');
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactSkill FROM tblartifacts WHERE ArtifactID = 5');
