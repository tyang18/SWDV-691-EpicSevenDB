        ...
        <div class="row main">
            <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <div class="row padding">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <p>
                            <!--Avatar Image-->
                            <img src="img/bellona-avatar.png" class="img-fluid mx-auto d-block" role="img">
                            </p>    
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            $result = $mysqli->query('SELECT UnitID, UnitClass, UnitElement, UnitZodiac, UnitGrade FROM tblunits WHERE UnitID = 5')
                        ...
                        $result = $mysqli->query('SELECT UnitID, UnitAttack, UnitDefense, UnitSpeed, UnitHealth, UnitGrade FROM tblunits WHERE UnitID = 5')
                ...
                <?php
                    ...
                    $result = $mysqli->query('SELECT SkillID, Skill1Name, Skill2Name, Skill3Name, Skill1Icon, Skill2Icon, Skill3Icon, Skill1Info, Skill2Info, Skill3Info FROM tblskills WHERE SkillID = 5')
