                ...
                <div class="col-12">
                    ...
                    <div class="row padding">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <p>
                            <!--Avatar Image-->
                            <img src="img/swordofezera-image.png" class="img-fluid mx-auto d-block" role="img">
                            </p>    
                        </div>
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <p>
                                "Because the color and shape is different to the holy sword wielded by the real life Ezeran legend..."
                                <br>
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactGrade, ArtifactClass, ArtifactHealth, ArtifactAttack FROM tblartifacts WHERE ArtifactID = 4');
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactSkill FROM tblartifacts WHERE ArtifactID = 4');
