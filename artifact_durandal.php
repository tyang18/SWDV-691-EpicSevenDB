                ...
                <div class="col-12">
                    ...
                    <div class="row padding">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <p>
                            <!--Avatar Image-->
                            <img src="img/durandal-image.png" class="img-fluid mx-auto d-block" role="img">
                            </p>    
                        </div>
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <p>
                                The soft light emitted by the sword shields its owner from all injuries.
                            </p>
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactGrade, ArtifactClass, ArtifactHealth, ArtifactAttack FROM tblartifacts WHERE ArtifactID = 2');
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactSkill FROM tblartifacts WHERE ArtifactID = 2');
