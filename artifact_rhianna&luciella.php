...
<html>
  <head>
    <title>Rhianna and Luciella</title>
	<meta charset="utf-8">
                ...
                <div class="col-12">
                    ...
                    <div class="row padding">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <p>
                            <!--Avatar Image-->
                            <img src="img/rnl-image.png" class="img-fluid mx-auto d-block" role="img">
                            </p>    
                        </div>
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <p>
                                You're today's target. I'll let you know now that there's nowhere to run.
                                <br>
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactGrade, ArtifactClass, ArtifactHealth, ArtifactAttack FROM tblartifacts WHERE ArtifactID = 3');
                            ...
                            $result = $mysqli->query('SELECT ArtifactID, ArtifactSkill FROM tblartifacts WHERE ArtifactID = 3');
